...
7. Problem: Blocked from appearing in search engines
...
Columns:
    1. URL
    2. Page block reason
9. Problem: With a <title> tag that is too long
...
Columns:
    1. URL
    2. Title long
10. Problem: With a <title> tag that is too short
